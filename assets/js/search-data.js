...
ninja.data = [{
    ...
    section: "Navigation",
    handler: () => {
      window.location.href = "/VAIL-UCLA.github.io/";
    },
  },{id: "nav-publications",
          title: "Publications",
          description: "",
          section: "Navigation",
          handler: () => {
            window.location.href = "/VAIL-UCLA.github.io/publications/";
          },
        },{id: "nav-awards",
          title: "Awards",
          description: "",
          section: "Navigation",
          handler: () => {
            window.location.href = "/VAIL-UCLA.github.io/awards/";
          },
        },{id: "nav-team",
          title: "Team",
          description: "",
          section: "Navigation",
          handler: () => {
            window.location.href = "/VAIL-UCLA.github.io/team/";
          },
        ...
        handler: () => {
            ...
            window.location.href = "/VAIL-UCLA.github.io/blog/2025/plotly/";
          ...
          section: "Books",handler: () => {
              window.location.href = "/VAIL-UCLA.github.io/books/the_godfather/";
          ...
          description: "",
          section: "News",},{id: "news-prof-zhou-gave-a-webinar-presentation-at-nvidia-robotics-to-talk-about-urban-simulation-for-autonomous-delivery",
          title: 'Prof. Zhou gave a webinar presentation at NVIDIA Robotics to talk about Urban...',
          description: "",
          section: "News",},{id: "news-prof-zhou-will-speak-at-iros-26-social-navigation-workshop-and-workshop-on-bridging-perspectives-in-navigation-lessons-learned-and-future-directions",
          title: 'Prof. Zhou will speak at IROS’26 Social Navigation Workshop and Workshop on Bridging...',
          description: "",
          section: "News",},{id: "news-sidewalkbench-flowpilot-bridgesim-dreamstream-and-cue-the-flow-were-accepted-to-corl-2026",
          title: 'SidewalkBench, FlowPilot, BridgeSim, DreamStream, and Cue the Flow were accepted to CoRL 2026....',
          description: "",
          section: "News",},{id: "projects-project-1",
          title: 'project 1',
          description: "with background image",
          section: "Projects",handler: () => {
              window.location.href = "/VAIL-UCLA.github.io/projects/1_project/";
            },},{id: "projects-project-2",
          title: 'project 2',
          description: "a project with a background image and giscus comments",
          section: "Projects",handler: () => {
              window.location.href = "/VAIL-UCLA.github.io/projects/2_project/";
            },},{id: "projects-project-3-with-very-long-name",
          title: 'project 3 with very long name',
          description: "a project that redirects to another website",
          section: "Projects",handler: () => {
              window.location.href = "/VAIL-UCLA.github.io/projects/3_project/";
            },},{id: "projects-project-4",
          title: 'project 4',
          description: "another without an image",
          section: "Projects",handler: () => {
              window.location.href = "/VAIL-UCLA.github.io/projects/4_project/";
            },},{id: "projects-project-5",
          title: 'project 5',
          description: "a project with a background image",
          section: "Projects",handler: () => {
              window.location.href = "/VAIL-UCLA.github.io/projects/5_project/";
            },},{id: "projects-project-6",
          title: 'project 6',
          description: "a project with no image",
          section: "Projects",handler: () => {
              window.location.href = "/VAIL-UCLA.github.io/projects/6_project/";
            },},{id: "projects-project-7",
          title: 'project 7',
          description: "with background image",
          section: "Projects",handler: () => {
              window.location.href = "/VAIL-UCLA.github.io/projects/7_project/";
            },},{id: "projects-project-8",
          title: 'project 8',
          description: "an other project with a background image and giscus comments",
          section: "Projects",handler: () => {
              window.location.href = "/VAIL-UCLA.github.io/projects/8_project/";
            },},{id: "projects-project-9",
          title: 'project 9',
          description: "another project with an image 🎉",
          section: "Projects",handler: () => {
              window.location.href = "/VAIL-UCLA.github.io/projects/9_project/";
            },},{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
